...
2. Copy the whmcs module files
	a. Download ResellerCamp’s WHMCS Registrar Module
		...
		- `For PHP 7.4, Ioncube 10.2  <https://www.dropbox.com/s/7t0rhhktbyw9wjo/liquid.zip?dl=0>`_ (last updated 2022-01-25)
		- `For PHP 7.3, Ioncube 10.2  <https://www.dropbox.com/s/lcqgov4vhhp1i1h/liquid.zip?dl=0>`_ (last updated 2020-01-25)
